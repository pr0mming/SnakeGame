...
public class Gameplay {
    ...
    private boolean Effect, Position_condition;
    ...
    */
    private void GenerateSnake() {  
        ...
        for (int i = y, l = Length_snake; l >= 0; i+=(Position_condition)?1:-1, l--) {
    ...
    */
    public void RestartEnvironment(boolean r) {                  
        ...
        SnakeGame.getTime().StartMotion((Position_condition)?0:1);
    }
    /*
    ...
    */
    ...
    public boolean getPositionCondition() {
